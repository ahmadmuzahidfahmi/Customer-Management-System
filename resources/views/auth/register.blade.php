...
<head>
    <meta charset="UTF-8">
    <title>Register — Customer Management System</title>
...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    ...
    <div class="w-full max-w-sm">
        ...
        <div class="bg-white rounded-lg shadow-lg p-8">
            <h1 class="text-xl font-bold text-gray-800 mb-6 text-center">Create an account</h1>
            ...
            <!-- Register Password -->
                ...
                <button
                    type="submit"
                    class="w-full bg-[rgb(70,192,189)] hover:opacity-90 text-white font-semibold rounded-lg py-2 transition-colors mt-3">
                    Create account
                </button>
            </form>
            ...
            <p class="text-sm text-gray-500 text-center mt-5">
                ...
                <a href="{{ route('login') }}" class="text-[rgb(70,192,189)] hover:underline font-medium">Sign in</a>
            </p>
        </div>
    </div>
