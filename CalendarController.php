...
class CalendarController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Weekly View — always shows the real current week,
        // independent of whichever month is being browsed above.
    ...
    public function week(Request $request)
    {
        ...
        ->whereDate('Dead_Line', '>=', $start->toDateString())
        ->whereDate('Dead_Line', '<=', $end->toDateString())
        ->orderBy('Dead_Line')
        ->get();
